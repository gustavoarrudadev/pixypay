-- Migration 056: Atualizar função buscar_detalhes_revenda para incluir campos de conta PIX
-- Primeiro remove a função antiga e depois cria a nova com os campos adicionais

DROP FUNCTION IF EXISTS public.buscar_detalhes_revenda(UUID);
